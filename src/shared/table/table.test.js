...
import { THead, BodyRow } from './Table';
import { Table, TableHeader, TableBody, Text } from '../'
...
describe('<Table />', () => {
    ...
    it('should respect the theme for the header border colour', () => {
        const component = render(<THead />).toJSON();
